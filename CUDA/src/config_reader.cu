...
__host__ SceneParams read_scene_from(const char* config_file){
	std::string text;
...
__host__ int get_int(std::string text){
...
__host__ float get_float(std::string text){
    std::stringstream ss(text);
    float ret = 0;
    std::string trash = "";
...
__host__ double get_double(std::string text){
    std::stringstream ss(text);
    double ret = 0;
    std::string trash = "";
...
__host__ vec3 get_vec3(std::string text){
...
__host__ color get_color(std::string text){
    std::replace(text.begin(), text.end(), ',', ' ');
    std::replace(text.begin(), text.end(), '(', ' ');
    std::replace(text.begin(), text.end(), ')', ' ');
...
__host__ std::string get_string(std::string text){
    std::istringstream ss(text);
    std::string name;
    std::string trash = "";
...
__host__ Sphere* get_sphere(std::string text){
    std::replace(text.begin(), text.end(), ',', ' ');
    std::replace(text.begin(), text.end(), '(', ' ');
    std::replace(text.begin(), text.end(), ')', ' ');
...
__host__ Plane* get_plane(std::string text){
    std::replace(text.begin(), text.end(), ',', ' ');
    std::replace(text.begin(), text.end(), '(', ' ');
    std::replace(text.begin(), text.end(), ')', ' ');
